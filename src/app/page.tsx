  ...
  return <main className="flex-1 bg-white">
    <section className="relative overflow-hidden border-b border-slate-200">
      ...
      <Container className="relative grid gap-12 py-14 sm:py-20 lg:grid-cols-[1.06fr_0.94fr] lg:items-center lg:py-24">
        ...
        <figure className="relative mx-auto w-full max-w-xl overflow-hidden rounded-[1.5rem] border border-slate-800 bg-[#00143a] shadow-[var(--shadow-raised)]">
          <Image src="/brand/duta-rantau-brand.webp" alt="DUTA Rantau — Bersama, Terhubung, Berdaya" width={1254} height={1254} preload sizes="(max-width: 1024px) 92vw, 42vw" className="h-auto w-full" />
          <figcaption className="absolute inset-x-4 bottom-4 rounded-xl border border-white/15 bg-slate-950/85 px-4 py-3 text-sm leading-6 text-slate-200 backdrop-blur-sm sm:inset-x-6 sm:bottom-6"><strong className="text-white">Satu identitas, banyak kebutuhan.</strong> Info, kerja, komunitas, dan bantuan untuk warga Indonesia di Malaysia.</figcaption>
        </figure>
      </Container>
    </section>
